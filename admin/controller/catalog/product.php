...
class ControllerCatalogProduct extends Controller {
    ...
    if ($this->config->get('config_editor_default')) {
		...
		//moe
		if (isset($this->request->post['hello_world'])) {
			$data['hello_world'] = $this->request->post['hello_world'];
		} elseif (!empty($product_info['hello_world'])) {
			$data['hello_world'] = $product_info['hello_world'];
		} else {
			$data['hello_world'] = '0';
		}
