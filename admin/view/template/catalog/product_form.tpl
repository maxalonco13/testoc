        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-hello-world"><?php echo $text_hello_world; ?></label>
                <div class="col-sm-10">
						<select name="hello_world" id="input-hello-world" class="form-control">
                    <?php if ($hello_world == 1) { ?>
                    <option value="1" selected="selected"><?php echo $text_plus; ?></option>
                    <option value="0"<?php echo $text_minus; ?>></option>
                    <?php } else { ?>
                    <option value="1"><?php echo $text_plus; ?></option>
                    <option value="0" selected="selected"><?php echo $text_minus; ?></option>
                    <?php } ?>
                  </select>
                </div>
              </div>
